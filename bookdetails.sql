...
--
-- Host: localhost:3306
-- Generation Time: Jun 12, 2019 at 08:27 PM
...
('Python Crash Course', 'Eric Mathees', 'Python Crash Course gets you up and running with Python, teaching you the basics quickly so that you can solve problems, make things, and do cool stuff. Each chapter explains a new programming concept and includes a set of exercises to help reinforce your new knowledge.', 'img/book/python.jpg', NULL, 'Academics'),
('Algorithm Design', 'Kleinberg', 'Algorithm Design introduces algorithms by looking at the real-world problems that motivate them. The book teaches students a range of design and analysis techniques for problems that arise in computing applications. The text encourages an understanding of the algorithm design process and an appreciation of the role of algorithms in the broader field of computer science.', 'img/book/algo.jpg', NULL, 'Academics'),
('Java - The Complete Reference', 'Herbert Schildt', 'This book is a comprehensive guide to the Java language, describing its syntax, keywords and fundamental programming principles. Significant portions of the Java API library are also examined. This book is for all programmers, whether you are a novice or an experienced pro. The beginner will find its carefully paced discussions and many examples especially helpful.', 'img/book/java.jpg', NULL, 'Academics'),
('Computer Graphics with OpenGL', 'Hearn Baker', 'Assuming no background in computer graphics, this textbook presents basic principles for the design, use and understanding of computer graphics systems and applications. The authors, authorities in their field, offer an integrated approach to two-dimensional and three-dimensional graphics topics.', 'img/book/cg.jpg', NULL, 'Academics');
COMMIT;
